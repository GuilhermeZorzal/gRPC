...
class SerializerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Add = channel.unary_unary(
                '/Serializer/Add',
                request_serializer=serializer__pb2.OperationRequest.SerializeToString,
                response_deserializer=serializer__pb2.ResultResponse.FromString,
                _registered_method=True)
        self.TesteSerial = channel.unary_unary(
                '/Serializer/TesteSerial',
...
def add_SerializerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Add': grpc.unary_unary_rpc_method_handler(
                    servicer.Add,
                    request_deserializer=serializer__pb2.OperationRequest.FromString,
                    response_serializer=serializer__pb2.ResultResponse.SerializeToString,
            ),
...
class Serializer(object):
    ...
    def Add(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Serializer/Add',
            serializer__pb2.OperationRequest.SerializeToString,
            serializer__pb2.ResultResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
